...
const defaultCodemirrorThemeSyntaxDark = {
...
const defaultCodemirrorThemeSyntaxLight = {
...
export const codemirrorTheme: Record<ThemeKeys, ThemeScheme> = {
  default: {
    light: {
      theme: "light",
      settings: {
      ...
      styles: [
        {
          tag: t.invalid,
          color: defaultCodemirrorThemeSyntaxLight.invalid
        },
        {
          tag: t.heading,
          fontWeight: "bold",
          color: defaultCodemirrorThemeSyntaxLight.heading
        },
        {
          tag: [t.comment, t.meta],
          color: defaultCodemirrorThemeSyntaxLight.comment
        },
        {
          tag: [t.annotation, t.tagName],
          color: defaultCodemirrorThemeSyntaxLight.tag
        },
        {
          tag: [t.bool, t.keyword],
          color: defaultCodemirrorThemeSyntaxLight.keyword
        },
        {
          tag: [t.changed, t.modifier, t.namespace, t.self, t.typeName],
          color: defaultCodemirrorThemeSyntaxLight.type
        },
        {
          tag: [t.constant(t.name), t.standard(t.name)],
          color: defaultCodemirrorThemeSyntaxLight.constant
        },
        {
          tag: [t.function(t.variableName), t.labelName, t.propertyName],
          color: defaultCodemirrorThemeSyntaxLight.function
        },
        {
          tag: [t.atom, t.character, t.deleted, t.definition(t.name), t.macroName, t.name, t.special(t.variableName)],
          color: defaultCodemirrorThemeSyntaxLight.variable
        },
        {
          tag: t.className,
          color: defaultCodemirrorThemeSyntaxLight.class
        },
        {
          tag: [t.docComment, t.inserted, t.processingInstruction, t.special(t.string), t.string],
          color: defaultCodemirrorThemeSyntaxLight.string
        },
        {
          tag: [t.color, t.number],
          color: defaultCodemirrorThemeSyntaxLight.number
        },
        {
          tag: [t.escape, t.link, t.regexp, t.url],
          color: defaultCodemirrorThemeSyntaxLight.regexp
        },
        {
          tag: t.strong,
          fontWeight: "bold"
    ...
    dark: {
      ...
      styles: [
        {
          tag: t.invalid,
          color: defaultCodemirrorThemeSyntaxDark.invalid
        },
        {
          tag: t.heading,
          fontWeight: "bold",
          color: defaultCodemirrorThemeSyntaxDark.heading
        },
        {
          tag: [t.comment, t.meta],
          color: defaultCodemirrorThemeSyntaxDark.comment
        },
        {
          tag: [t.annotation, t.tagName],
          color: defaultCodemirrorThemeSyntaxDark.tag
        },
        {
          tag: [t.bool, t.keyword],
          color: defaultCodemirrorThemeSyntaxDark.keyword
        },
        {
          tag: [t.changed, t.modifier, t.namespace, t.self, t.typeName],
          color: defaultCodemirrorThemeSyntaxDark.type
        },
        {
          tag: [t.constant(t.name), t.standard(t.name)],
          color: defaultCodemirrorThemeSyntaxDark.constant
        },
        {
          tag: [t.function(t.variableName), t.labelName, t.propertyName],
          color: defaultCodemirrorThemeSyntaxDark.function
        },
        {
          tag: [t.atom, t.character, t.deleted, t.definition(t.name), t.macroName, t.name, t.special(t.variableName)],
          color: defaultCodemirrorThemeSyntaxDark.variable
        },
        {
          tag: t.className,
          color: defaultCodemirrorThemeSyntaxDark.class
        },
        {
          tag: [t.docComment, t.inserted, t.processingInstruction, t.special(t.string), t.string],
          color: defaultCodemirrorThemeSyntaxDark.string
        },
        {
          tag: [t.color, t.number],
          color: defaultCodemirrorThemeSyntaxDark.number
        },
        {
          tag: [t.escape, t.link, t.regexp, t.url],
          color: defaultCodemirrorThemeSyntaxDark.regexp
        },
        {
          tag: t.strong,
          fontWeight: "bold"
